...
export const PropertyForm: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!formData.address || !formData.landlordName || !formData.landlordPhone) {
      toast({
  ...
  return <Card className="border border-gray-100 shadow-lg">
      <CardContent className="p-6">
        {submitted ? <div className="text-center py-16 space-y-4">
            ...
            <Button onClick={() => navigate('/cart')} className="bg-[#FF385C] hover:bg-[#e0334f] text-white mt-4">
              View Cart
            </Button>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="mt-1.5 relative">
                  ...
                  <Input id="address" name="address" placeholder="Enter the complete property address" value={formData.address} onChange={handleChange} className="pl-10 bg-white border-gray-300" required />
                </div>
              </div>
              
              <div>
                <Label htmlFor="description" className="text-base">Property Description</Label>
                <Textarea id="description" name="description" placeholder="Add any additional details about the property" value={formData.description} onChange={handleChange} className="mt-1.5 bg-white border-gray-300" rows={3} />
              </div>
              ...
              <div className="pt-4 border-t border-gray-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input id="landlordName" name="landlordName" placeholder="Landlord's full name" value={formData.landlordName} onChange={handleChange} className="mt-1.5 bg-white border-gray-300" required />
                  </div>
                  ...
                  <div>
                    ...
                    <Input id="landlordEmail" name="landlordEmail" type="email" placeholder="Landlord's email address" value={formData.landlordEmail} onChange={handleChange} className="mt-1.5 bg-white border-gray-300" />
                  </div>
                  ...
                  <div>
                    ...
                    <Input id="landlordPhone" name="landlordPhone" placeholder="Landlord's phone number" value={formData.landlordPhone} onChange={handleChange} className="mt-1.5 bg-white border-gray-300" required />
                  </div>
                  
                  <div>
                    <Label htmlFor="landlordCompany" className="text-base">Company (Optional)</Label>
                    <Input id="landlordCompany" name="landlordCompany" placeholder="Landlord's company name" value={formData.landlordCompany} onChange={handleChange} className="mt-1.5 bg-white border-gray-300" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-end">
              <Button type="submit" className="w-full sm:w-auto bg-[#FF385C] hover:bg-[#e0334f] text-white px-8 py-2.5 text-lg" disabled={isLoading}>
                {isLoading ? <>
