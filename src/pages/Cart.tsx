  ...
  return <div className="container max-w-4xl py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          <Card className="mb-6">
            <div className="p-6">
              ...
              <div className="space-y-4">
                {properties.map(property => <div key={property.id} className="border rounded-lg p-4">
                    ...
                    <div className="mt-4 pt-4 border-t">
                      <div className="flex justify-between items-center mb-2">
                        ...
                        {property.landlordInfo ? <Button variant="ghost" size="sm" onClick={() => handleEditLandlord(property.id)}>
                            <Edit2 className="h-3.5 w-3.5 mr-1" />
                            Edit
                          </Button> : <span className="text-xs text-amber-600 font-medium">Required</span>}
                      </div>
                      
                      {property.landlordInfo ? <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-sm">
                          <div>
                          ...
                          {property.landlordInfo.company && <div>
          ...
          {!isAuthenticated && <Card className="bg-muted/50 border-muted">
          ...
          <Card>
            <div className="p-6">
              ...
              <div className="space-y-2 text-sm">
                ...
                {getDiscount() > 0 && <div className="flex justify-between text-green-600">
                ...
                {properties.length > 5 ? <p className="text-xs text-green-600 mt-1">
                    15% discount applied for 5+ properties!
                  </p> : properties.length > 3 ? <p className="text-xs text-muted-foreground mt-1">
                    Add {6 - properties.length} more for a 15% discount!
                  </p> : null}
              </div>
              
              {!allPropertiesHaveLandlordInfo && <div className="mt-4 mb-4 p-2 bg-amber-50 border border-amber-200 rounded-md text-amber-800 text-sm">
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input id="name" value={landlordInfo.name} onChange={e => setLandlordInfo({
              ...landlordInfo,
              name: e.target.value
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input id="email" type="email" value={landlordInfo.email} onChange={e => setLandlordInfo({
              ...landlordInfo,
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input id="phone" type="tel" value={landlordInfo.phone} onChange={e => setLandlordInfo({
              ...landlordInfo,
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input id="company" value={landlordInfo.company || ''} onChange={e => setLandlordInfo({
              ...landlordInfo,
